//bringing all elements from html to js
...
const API_KEY = '50adf436af1a9b61c44708784a742ffb'; 

//time and date - without api
setInterval(() => {
    ...
    const hour = time.getHours(); //gives 24 hour clock
    const hoursIn12HrFormat = hour >=13 ? hour%12:hour; //setting in 12 hour format
